...
export function PrintSettingsDialog({ file, open, onOpenChange }: PrintSettingsDialogProps) {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-4xl p-0 overflow-hidden bg-zinc-50 gap-0">
                <div className="flex flex-col lg:flex-row h-[80vh] lg:h-auto">
                    {/* Main Content */}
                    <div className="flex-1 p-6 overflow-y-auto max-h-[calc(80vh-100px)] lg:max-h-[80vh]">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-3">
                                <h3 className="font-semibold text-zinc-900">Paper Layout</h3>
                            ...
                            {/* Print Density */}
                            <div className="space-y-3">
                                <h3 className="font-semibold text-zinc-900">Print Density</h3>
                            ...
                            {/* Pages Per Sheet */}
                            <div className="space-y-3">
                                <h3 className="font-semibold text-zinc-900">Pages Per Sheet (N-Up)</h3>
                                <div className="grid grid-cols-5 gap-2">
                                    {[1, 2, 4, 6, 8].map((num) => (
                                        <button
                                            ...
                                            className={cn(
                                                "relative p-3 rounded-xl border-2 text-center transition-all flex flex-col items-center justify-center h-20",
                            ...
                            {/* Number of Copies */}
                            <div className="space-y-3">
                                <h3 className="font-semibold text-zinc-900">Number of Copies</h3>
                    ...
                    {/* Sidebar / Footer */}
                    <div className="w-full lg:w-80 bg-white border-t lg:border-t-0 lg:border-l border-zinc-200 p-6 flex flex-col justify-between">
                        <div className="space-y-6">
                            <h3 className="font-bold text-zinc-900 text-lg pt-4 border-t border-zinc-100">Price Summary</h3>
                            <div className="space-y-3 text-sm">
                                ...
                                <div className="pt-3 border-t border-zinc-100 flex justify-between items-center">
                                    ...
                                    <span className="text-3xl font-bold text-zinc-900">₹{price.total}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="mt-8 space-y-3">
                            ...
                            <div className="p-3 rounded-lg bg-emerald-50 border border-emerald-100 flex items-center gap-2 text-xs text-emerald-700">
